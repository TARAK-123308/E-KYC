...
<%
					...
					String file=null;
					String a=null,b=null,c=null,d=null,image=null,email=null,mno=null;
					String ee[]=null;
					String checkBok=" ";
					int ff=0;
					String bin = "";
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							{
								deptt=multi.getParameter(paramname);
							}
							if(paramname.equalsIgnoreCase("spec"))
							{
								specc=multi.getParameter(paramname);
							}
					...
					if ( rs1.next() )
					   {
								...
								out.println("Owner Name Already Exist");							
							%>
							<p><a href="ow_register.jsp">Back</a>         <a href="index.html">Home</a> </p>
							<%
					   }
					   else
					   {

					  PreparedStatement ps=connection.prepareStatement("insert into owner (name,pass,dept,spec,image,status,email,mobile,addr,dob,gender,pin) values(?,?,?,?,?,?,?,?,?,?,?,?)");
						ps.setString(1,uname);
						ps.setString(2,pass);
						ps.setString(3,deptt);	
						ps.setString(4,specc);
						...
						if(x>0){
								out.println("Registered Sucessfully as Owner");							
