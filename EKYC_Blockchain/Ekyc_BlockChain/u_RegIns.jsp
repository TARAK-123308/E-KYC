...
<%
					...
					if ( rs1.next() )
					  ...
					  PreparedStatement ps=connection.prepareStatement("insert into user (name,pass,dept,prof,image,status,email,mobile,addr,dob,gender,pin) values(?,?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0){
								out.println("Registered Sucessfully as User");							
